...
const closeRef= useRef()
  ...
  return (
    <div>
    <div className={`flex justify-center items-center flex-col  mt-[150px]`} id={bikes?.name} ref={refcall}>
    <div className={`w-[60%] pb-20 ${bikes?.name==="stealth"?"bg-sum-gray":"bg-sum-white"} mt-[150px]`} >
...
<div class="absolute inset-0 h-full w-full [transition:all_0.8s_ease] group-hover:bg-sum-blue group-hover:bg-opacity-60 "></div>
    ...
    <div className='text-[22px] flex justify-center items-center '>
        <p className='w-[60%] '>ALPA is a multifunctional vehicle, ideal for rapid postal or food delivery services but also convertible for 
